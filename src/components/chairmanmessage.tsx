    ...
    <section className="py-16 px-6 md:px-16 bg-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/3 w-full flex justify-center">
          <Image
            src="/aboutus/chairman.jpg" // Update this with your actual image path
        ...
        <div className="md:w-2/3 w-full text-center md:text-left">
          <h2 className="text-3xl font-bold text-gray-900">Message from the Chairman</h2>
          <p className="mt-4 text-gray-700 leading-relaxed">
            It is my privilege to welcome you to Delhi World School. For over 30 years, I have 
            strived to create schools facilitating holistic development per excellence standards.
          </p>
          <p className="mt-4 text-gray-700 leading-relaxed">
